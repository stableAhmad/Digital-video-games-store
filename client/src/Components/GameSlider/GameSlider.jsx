...
export default function GameSlider() {
  return (
    ...
    <Carousel className={styles.mainSlide} showThumbs={false}>
      {gameSlides.map((slide, index) => (
        <div className={`container-fluid ${styles.slideContainer}`} key={index}>
          <div className="row">
            <div className="col-9">
              <div className="row">
                <div className={`col-lg-12 ${styles.slideInfo}`}>
            ...
            <div className="col-3">
              <div className={`col-lg-12 ${styles.slideInfo} d-flex flex-column `}>
                ...
                <div className={`${styles.info} card mb-5 p-4`}>
                  ...
                  <button className={`${styles.Addbtn} btn mt-3 w-50 m-2`}>Add to Cart</button>
                </div>
                {/* Images under the card */}
                <div className="d-flex">
                  {slide.smallImages.map((image, imageIndex) => (
                    <img
                      src={image}
                      alt={`slide ${index + 1}`}
